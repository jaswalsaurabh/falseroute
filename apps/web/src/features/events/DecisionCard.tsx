        ...
        (simulatedEffect ? (
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 'var(--space-unit-xs)' }}>
                <Badge variant="neutral">PROVENANCE: {simulatedEffect.provenance}</Badge>
                <Badge variant="simulated">{simulatedEffect.status}</Badge>
              </div>
            </div>
            ...
            >
              ...
              <p>
                ...
                <code>{simulatedEffect.assignedFalseRoute}</code>
              </p>
              <div
                style={{
                  padding: 'var(--space-unit-sm)',
              ...
              >
                <p>
                  <strong>Containment Mode:</strong> {simulatedEffect.containmentMode}
                </p>
          ...
          <div
            data-testid="simulated-effect-card-unavailable"
            style={{
              padding: 'var(--space-unit-md)',
              backgroundColor: 'var(--surface-card)',
          ...
          >
            ...
            >
              ...
              <div style={{ display: 'flex', gap: 'var(--space-unit-xs)' }}>
                <Badge variant="neutral">PROVENANCE: UNAVAILABLE</Badge>
            ...
            >
              <p>
                ...
                <span style={{ color: 'var(--status-warning-text)', fontWeight: 600 }}>
                  Simulated effect record unavailable
                </span>
              </p>
              <p style={{ fontSize: 'var(--text-size-xs)', color: 'var(--text-secondary)' }}>
                Expected a recorded simulated deception effect for false route{' '}
                <code>{decision.assignedFalseRoute}</code>, but no effect record was provided.
              </p>
            </div>
          </div>
        ))}
